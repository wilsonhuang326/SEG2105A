...
public class PointCPTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Polar-Cartesian Coordinates Conversion Program");
        ...
        System.out.println("\nYou entered:\n" + point);
        System.out.println(point.convertStorageToCartesian());
    }
    ...
    private static PointCP2 getInput() throws IOException {
        ...
        for (int i = 0; i < 2; i++) {
            while (!(isOK)) {
                ...
                // Prompt the user
                    System.out.print("Enter the value of " + (i == 0 ? "Rho " : "Theta ")
